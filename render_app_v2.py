...
def get_final_feedback(scores):
    ...
    if avg >= 9:
        return "🏆 优秀！你的销售话术非常专业，能够灵活应对各种场景。建议继续保持，可以尝试更高难度的角色挑战。"
    elif avg >= 7:
        return "🥈 良好！你掌握了基本的销售话术技巧，但在某些环节还有提升空间。建议多练习异议处理和促成成交。"
    elif avg >= 5:
        return "🥉 及格！你对产品有一定了解，但话术需要更加熟练。建议加强产品知识学习，多进行模拟练习。"
    else:
        return "📚 需改进！建议系统学习销售话术技巧，从基础开始逐步提升。可以参考标准话术模板，多练习后再来挑战。"
